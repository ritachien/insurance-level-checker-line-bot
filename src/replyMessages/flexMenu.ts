  ...
  contents: [
    {
      ...
      action: {
        ...
        displayText: '⭐︎ 本查詢服務僅提供本國人查詢。若您是外國人，會因代扣金額不同而查無資料(外國人無須繳納就業保險費)。\n\n👉 請輸入指令：「勞保代扣=金額」進行查詢!\n👉 範例: 勞保代扣=607'
      },
    },
    {
      type: 'button',
    ...
    },
    {
      ...
      action: {
        ...
        displayText: '⭐︎ 本查詢服務用「單人」代扣金額查詢，若您有加保眷屬，請將實際代扣金額除以(計費眷屬 + 1)後再進行查詢。\n⭐︎ 各縣市針對特定身分(重大傷病/原住民/達一定年齡...)可能提供補助，本服務僅針對一般狀況進行查詢。\n\n👉 請輸入指令：「新制提撥=金額」進行查詢(預設為投保金額 6%)!\n👉 範例: 新制提撥=6000'
      }
    }
  ]
}
